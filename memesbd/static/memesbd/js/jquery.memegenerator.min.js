            ...
            this.settings = e.extend(!0, {}, {
                ...
                bootstrapify: function() {
                    ...
                    i.wrapper.hasClass("usingBootstrap") || t.wrapInner('<div class="container-fluid"></div>'), i.wrapper.addClass("usingBootstrap"), t.find(".mg-textbox").each(function() {
                        e(this).hasClass("row") || (e(this).addClass("row"), e(this).find(".mg-textbox-text").addClass("form-control").wrap(e("<div></div>").addClass("col-md-6")), e(this).find(".mg-textbox-size").addClass("form-control").wrap(e("<div></div>").addClass("col-md-3")), e(this).find(".mg-textbox-border-width").addClass("form-control").wrap(e("<div></div>").addClass("col-md-0")), e(this).find(".colorpicker").addClass("form-control"), e(this).find(".colorpickerContainer").eq(0).addClass("col-md-3"),e(this).find(".colorpickerContainer").eq(1).css('display','none'), e(this).find(".colorpickerReplacer").addClass("btn btn-default"))
